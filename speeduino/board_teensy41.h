...
*/
  ...
  */
  ...
  #define KNOCK1_COUNTER  TMR3_CNTR1
  #define KNOCK2_COUNTER  TMR3_CNTR2
  #define KNOCK3_COUNTER  TMR3_CNTR3
  #define KNOCK4_COUNTER  TMR4_CNTR1
  #define KNOCK5_COUNTER  TMR4_CNTR2
  ...
  #define KNOCK1_COMPARE  TMR3_COMP11
  #define KNOCK2_COMPARE  TMR3_COMP12
  #define KNOCK3_COMPARE  TMR3_COMP13
  #define KNOCK4_COMPARE  TMR4_COMP11
  #define KNOCK5_COMPARE  TMR4_COMP12
  ...
  static inline void KNOCK1_TIMER_ENABLE(void)  {TMR3_CSCTRL1 &= ~TMR_CSCTRL_TCF1; TMR3_CSCTRL1 |= TMR_CSCTRL_TCF1EN;}
  static inline void KNOCK2_TIMER_ENABLE(void)  {TMR3_CSCTRL2 &= ~TMR_CSCTRL_TCF1; TMR3_CSCTRL2 |= TMR_CSCTRL_TCF1EN;}
  static inline void KNOCK3_TIMER_ENABLE(void)  {TMR3_CSCTRL3 &= ~TMR_CSCTRL_TCF1; TMR3_CSCTRL3 |= TMR_CSCTRL_TCF1EN;}
  static inline void KNOCK4_TIMER_ENABLE(void)  {TMR4_CSCTRL1 &= ~TMR_CSCTRL_TCF1; TMR4_CSCTRL1 |= TMR_CSCTRL_TCF1EN;}
  static inline void KNOCK5_TIMER_ENABLE(void)  {TMR4_CSCTRL2 &= ~TMR_CSCTRL_TCF1; TMR4_CSCTRL2 |= TMR_CSCTRL_TCF1EN;}
  
  static inline void KNOCK1_TIMER_DISABLE(void)  {TMR3_CSCTRL1 &= ~TMR_CSCTRL_TCF1EN;}
  static inline void KNOCK2_TIMER_DISABLE(void)  {TMR3_CSCTRL2 &= ~TMR_CSCTRL_TCF1EN;}
  static inline void KNOCK3_TIMER_DISABLE(void)  {TMR3_CSCTRL3 &= ~TMR_CSCTRL_TCF1EN;}
  static inline void KNOCK4_TIMER_DISABLE(void)  {TMR4_CSCTRL1 &= ~TMR_CSCTRL_TCF1EN;}
  static inline void KNOCK5_TIMER_DISABLE(void)  {TMR4_CSCTRL2 &= ~TMR_CSCTRL_TCF1EN;}

...
void DashMessage(uint16_t DashMessageID)
{
  ...
  switch (DashMessageID)
  {
    ...
    case CAN_RUSEFI_OILP_OILT:
      ...
      temp_oilTemp = currentStatus.OILT + 40;
      ...
      outMsg.buf[4] = (uint8_t)temp_oilTemp;
    ...
    case CAN_RUSEFI_EGT:
      temp_EGT1 = currentStatus.canin[0] / 5;
      outMsg.len = 8;
      outMsg.buf[0] = (uint8_t)(temp_EGT1);
      outMsg.buf[1] = (uint8_t)(temp_EGT1);
      outMsg.buf[2] = 0x00;
      outMsg.buf[3] = 0x00;
      outMsg.buf[2] = 0x00;
      outMsg.buf[3] = 0x00;
